/*! NoSleep.min.js v0.9.0 - git.io/vfn01 - Rich Tibbett - MIT license */ !function(A, e) {
    ...
    return function(A) {
        ...
        function(A, e, o) {
            ...
            }(), t = o(1), n = t.webm, c = t.mp4, E = "undefined" != typeof navigator && parseFloat(("" + (/CPU.*OS ([0-9_]{3,4})[0-9_]{0,1}|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent) || [
                0,
                ""
            ])[1]).replace("undefined", "3_2").replace("_", ".").replace("_", "")) < 10 && !window.MSStream, l = function() {
                function A() {
                    var e = this;
...
//# sourceMappingURL=index.2651efe3.js.map
